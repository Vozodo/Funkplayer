<?php
//STATION SETTINGS
define("StationName", "Station Name");
define("StationSlogan", "Station Slogan");
define("StationLogo", "view/img/Default_Logo.png");
define("StationWebsite", "Station Website");
define("StationStreamURL", "https://stream.examplestation.tld/");
...
define("IM_EX_URL", "http://imageapi.examplestation.tld/Funkplayer/image_api/index.php");
